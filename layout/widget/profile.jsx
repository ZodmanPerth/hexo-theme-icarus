    ...
    renderSocialLinks(links) {
        ...
        return <div class="level is-mobile is-multiline">
            {links.filter(link => typeof link === 'object').map(link => {
                return <a class="level-item button link-button is-transparent is-marginless"
        ...
        return <div class="card widget" data-type="profile">
            <div class="card-content">
                <nav class="level">
                    <div class="level-item has-text-centered flex-shrink-1">
                        <div>
                            ...
                            {location ? <p class="is-size-6 is-flex justify-content-center is-location">
                ...
                {followLink ? <div class="level">
                    <a class="level-item button follow-button is-primary is-rounded" href={followLink} target="_blank" rel="noopener">{followTitle}</a>
                </div> : null}
